...
This fork adds a simple node server and allows to edit and run the boids demo without compiling typescript.
Usage : just run "node server.js" from project root folder and open http://localhost:8080
