...
import {vec3, vec4} from '/dependencies/gl-matrix.js';
import Stats from '/dependencies/stats.js';
import {ComputeShaderProgramUniform} from './boids/project/ComputeShaderProgramUniform.js';
import {GLTF} from './boids/project/GLTF.js';
import {GUIPanel} from './boids/project/GUIPanel.js';
import {LightingShaderProgram} from './boids/project/LightingShaderProgram.js';
import {LightingShaderProgramUniform} from './boids/project/LightingShaderProgramUniform.js';
import {RGB} from './boids/project/RGB.js';
import {Camera} from './boids/webgl/Camera.js';
import {ProgramObject} from './boids/webgl/ProgramObject.js';
import {RoundCameraController} from './boids/webgl/RoundCameraController.js';
import {SceneObject} from './boids/webgl/SceneObject.js';

import getComputeShader from './boids_compute_shader_glsl.js'
...
class Main
{
    ...
    async init()
    {
        ...
        this.model = new GLTF();
        await this.model.loadModel('boids/assets/Suzanne.gltf', true);
